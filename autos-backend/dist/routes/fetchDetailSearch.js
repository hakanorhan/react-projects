...
const selectQueryDetail = "SELECT c.carid, b.brand, m.model, c.price, ct.cartype, c.km, c.year, c.month, t.transmissionname, ai.advertiseddate, c.ps, c.previousowner, c.hubraum,"
...
export default async (req, res) => {
    ...
    try {
        ...
        const { carid, brand, model, price, cartype, km, year, month, transmissionname, advertiseddate, ps, previousowner, hubraum, aunew, hunew, doors, accident, fuelname, iscardealer, klimaname, description, scheckheft, fittodrive, abstandstempomat, ambientbeleuchtung, headupdisplay, totwinkelassistent } = result[0];
        const axiosData = {
