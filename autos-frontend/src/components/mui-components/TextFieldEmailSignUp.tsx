...
import { setValuesEmail } from '../../redux/features/signupFormularSlice.js';

import { IUseForm } from '../../interfaces/IUseForm.js';

const TextFieldEmailSignUp:React.FC<IUseForm> = ({id, htmlForString, label}) => {
    ...
    const dispatch = useDispatch();
      ...
      // using this value in TextFieldEmail, in onBlur. set the value in redux for submitting in parent component
      const [emailValue, setEmailValue] = useState("");

  /**
   * 
   * @param event User fill password field
   */
...
export default TextFieldEmailSignUp;