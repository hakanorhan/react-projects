...
import { Button, Checkbox, FormControlLabel, FormControl, InputLabel, OutlinedInput, InputAdornment, IconButton, Box, Typography } from '@mui/material';
import * as ReduxHelper from '../../../helper/validHelper.js';
import { Visibility, VisibilityOff } from '@mui/icons-material';
import CheckIcon from '@mui/icons-material/Check'
import * as ValidHelper from '../../../helper/validHelper.js';
import { DivFormularAdmin, DivTwoFieldsWithSpaceBetween, DivWidthTwoFieldsRow, HeaderIcon, ValidParagraph, primaryColorMain, themeColor } from '../../../themes/ThemeColor.js';
