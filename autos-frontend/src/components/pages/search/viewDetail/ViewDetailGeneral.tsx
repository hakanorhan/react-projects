          ...
          <Grid sx={{ paddingTop: COMPONENT_DISTANCE }} item xs={12}>
            <Grid container>
              <Grid sx={{ display: 'flex' }} item xs={4}>
                <ShareIcon sx={{ marginRight: COMPONENT_DISTANCE }} /> <Typography sx={{ fontFamily: fontBold }} variant='body1' component='p'>{"Teilen"}</Typography>
              </Grid>
              <Grid sx={{ display: 'flex', justifyContent: 'center' }} item xs={4}>
                <FavoriteBorderIcon sx={{ marginRight: COMPONENT_DISTANCE }} /> <Typography sx={{ fontFamily: fontBold }} variant='body1' component='p'>{"Merken"}</Typography>
              </Grid>
            ...
            <Grid sx={{ height: '100%', paddingTop: COMPONENT_DISTANCE }} container >
              {/* Marke Modell */}
              <Grid item xs={12}> <Typography sx={{ fontFamily: fontBold, paddingBottom: COMPONENT_DISTANCE }} variant='h6' component='h1'>{`${detailSearchValues?.brand} ${detailSearchValues?.model}`}</Typography> </Grid>
              ...
              <Grid item xs={detailSearchValues.city.length > 13 ? 12 : gridItemXS} sm={detailSearchValues.city.length > 13 ? 12 : gridItemSM} md={detailSearchValues.city.length > 13 ? 12 : gridItemSM} lg={detailSearchValues.city.length > 13 ? 12 : 4} xl={detailSearchValues.city.length > 8 ? 12 : 4}>
                <Box display='flex' justifyContent='left' >
