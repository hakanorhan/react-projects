...
export function formularMileageIsValid(mileage: number) {
...
export function formularOwnerIsValid(value: number) {
    return REGEX.REGEX_OWNER.test(value.toString());
}

export function formularPowerIsValid(value: number) {
    return REGEX.REGEX_POWER.test(value.toString());
}

export function formularHubraumIsValid(value: number) {
    return REGEX.REGEX_HUBRAUM.test(value.toString());
}

export function formularPriceIsValid(value: number) {
    return REGEX.REGEX_PRICE.test(value.toString());
}

export function formularNamesIsValid(value: string) {
    return REGEX.REGEX_NAMES.test(value);
}